...
namespace FunkeySelectorGUI.UserControls
{
    partial class OptionsButton
    {
        ...
        {
            this.options = new FunkeySelectorGUI.UserControls.ChangeFormButton();
            this.SuspendLayout();
            // 
            // options
            // 
            this.options.BackColor = System.Drawing.Color.Transparent;
            this.options.BackgroundImage = global::FunkeySelectorGUI.Properties.Resources._679;
        ...
        private FunkeySelectorGUI.UserControls.ChangeFormButton options;
    }
}
